...
class Keyboard_Mole(Mole):
    def __init__(self):
        ...
        self.score = 1
        self.image_paths = [
            ("C:/Users/USER/Documents/GitHub/MoleClicker/up_mole.jpg", Qt.Key_Up),
            ("C:/Users/USER/Documents/GitHub/MoleClicker/down_mole.jpg", Qt.Key_Down),
            ("C:/Users/USER/Documents/GitHub/MoleClicker/right_mole.jpg", Qt.Key_Right),
            ("C:/Users/USER/Documents/GitHub/MoleClicker/left_mole.jpg", Qt.Key_Left)
        ]
...
def save_game_data(name, score, maxCombo, clickCnt, moleCnt, playTime):
    csvList = []
    ...
    csvList.append([name, score, maxCombo, clickCnt, moleCnt, f"{accuracy:.2f}", playTime]) 
...
class MoleClicker_Ingame_GUI(QWidget):
    ...
    def start_game_round(self):
        global total_score, click_count, mole_hit_count, game_time
        total_score = 0
        click_count = 0
        mole_hit_count = 0
        game_time = 0 
        self.current_game_time = self.game_duration
    ...
    def end_game_round(self):
        ...
        if ok and player_name:
            save_game_data(player_name, total_score, combo, click_count, mole_hit_count, final_play_time)
