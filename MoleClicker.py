...
class Classic_Mole(Mole):       # 일반 두더지
    def __init__(self):
        super().__init__()
        self.score = 1
        self.image_path = "classic_mole.jpg"
...
class Doubleclick_Mole(Mole):   # 더블클릭 두더지
    def __init__(self):
        super().__init__()
        self.score = 1
        self.image_path = "Doubleclick_mole.jpg"
...
class Rightclick_Mole(Mole):    # 우클릭 두더지
    def __init__(self):
        super().__init__()
        self.score = 1
        self.image_path = "Rightclick_mole.jpg"
...
class Bonus_Mole(Mole):         # 보너스 두더지
    def __init__(self):
        super().__init__()
        self.score = 3
        self.image_path = "bonus_mole.jpg"
...
class MoleClicker_Ingame_GUI(QWidget):
    ...
    def initUI(self):
        background_image_path = r'C:/Users/USER/Desktop/teamproject/Ingame_bg.png'
        hole_image_path = r'C:/Users/USER/Desktop/teamproject/empty_hole.png'
